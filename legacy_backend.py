"""Original small-model experiment; opt in with backend='legacy'."""
...
class LegacyChatService:
    ...
    @property
    def status(self) -> str:
        return f"Experimental trained model ({self.device}); limited dialogue retrieval"
...
__all__ = ["LegacyChatService", "SPECIAL_TOKENS", "intent_response"]
